// Adjusted from Patrick's version here: https://gist.github.com/ffyhlkain/2111681c1df404108837ffa5f71e0f68
...
namespace FoundationEditor.Editor.ReferenceFinder
{
    public class ReferenceFinder : EditorWindow
    {
        ...
        {
            GUILayout.Label("Referenced by: " + referenceObjectsDictionary.Count + " assets. (Last search duration: " + searchTimer.Elapsed + ")");
